...
export default function CataloguePage(){
  ...
  return <main className="page">
    ...
    <section className="panel">
      <div className="panelTitle"><div><small>01</small><h2>{fr?"Bouton public":"Public button"}</h2></div><div className="preview" style={{background:card.catalog_button_color||"#111827",color:card.catalog_button_text_color||"#fff"}}><span>{getCatalogIcon(card.catalog_icon)}</span>{card.catalog_label_fr||"Nos services"}</div></div>
