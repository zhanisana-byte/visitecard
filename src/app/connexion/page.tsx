...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Compatibilité avec l'ancien code de /mon-espace.
      localStorage.setItem("visitecard_access_token", data.session.access_token);
      localStorage.setItem("visitecard_refresh_token", data.session.refresh_token);
      localStorage.setItem("visitecard_user", JSON.stringify(data.user));
